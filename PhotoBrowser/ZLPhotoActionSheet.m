...
- (IBAction)btnCamera_Click:(id)sender
{
    ...
    if (self.configuration.useSystemCamera) {
        ...
        camera.allowEditImage = self.configuration.allowEditImage;
        camera.allowEditVideo = self.configuration.allowEditVideo;
        ...
        ZLImageNavigationController *nav = [self getImageNavWithRootVC:camera];
